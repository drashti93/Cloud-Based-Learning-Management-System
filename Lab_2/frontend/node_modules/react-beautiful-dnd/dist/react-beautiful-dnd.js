(function (global, factory) {
	...
	var ErrorBoundary = function (_React$Component) {
	  ...
	  function ErrorBoundary() {
	    ...
	    _this.recover = void 0;

	    _this.setOnError = function (onError) {
	      _this.recover = onError;
	    };
	...
	*/
	...
	var shallowEqual$1 = function shallowEqual(newValue, oldValue) {
	  return newValue === oldValue;
	};

	var simpleIsEqual = function simpleIsEqual(newArgs, lastArgs) {
	  return newArgs.length === lastArgs.length && newArgs.every(function (newArg, index) {
	    return shallowEqual$1(newArg, lastArgs[index]);
	  });
	};
	...
	function useMouseSensor(args) {
	  var canStartCapturing = args.canStartCapturing,
	      ...
	      getShouldRespectForceTouch = args.getShouldRespectForceTouch,
	...
	function useTouchSensor(args) {
	  ...
	  var windowBindings = useMemoOne(function () {
	    ...
	    return bindings;
	  }, [callbacks, cancel, getIsCapturing, getShouldRespectForceTouch, schedule, stop]);
	  var bindWindowEvents = useCallbackOne(function () {
	    var win = getWindow();
	    var options = {
	      capture: true
	...
	function useValidation$1(getDraggableRef) {
	  React.useEffect(function () {
	    {
	...
	function useDragHandle(args) {
	  ...
	  var lastArgsRef = usePrevious(args);
	  useValidation$1(getDraggableRef);
	  ...
	  }, [callbacks, getDraggableRef, getWindow, canStartCapturing, onCaptureStart, onCaptureEnd, getShouldRespectForceTouch]);
	  ...
	  }, [callbacks, getDraggableRef, getWindow, canStartCapturing, getShouldRespectForceTouch, onCaptureStart, onCaptureEnd]);
	...
	function Draggable(props) {
	  ...
	  var children = props.children,
	      ...
	      shouldRespectForceTouch = props.shouldRespectForceTouch,
	  ...
	  var getShouldRespectForceTouch = useCallbackOne(function () {
	    return shouldRespectForceTouch;
	  ...
	  }, [callbacks, canDragInteractiveElements, draggableId, getRef, getShouldRespectForceTouch, isDragDisabled, isDragging, isDropAnimating]);
