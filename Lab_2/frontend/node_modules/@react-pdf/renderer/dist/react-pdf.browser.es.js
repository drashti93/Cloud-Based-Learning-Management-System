...
var register = function register(src, _ref2) {
  var family = _ref2.family,
      otherOptions = _objectWithoutPropertiesLoose(_ref2, ["family"]);
...
var registerEmojiSource = function registerEmojiSource(_ref3) {
  var url = _ref3.url,
      _ref3$format = _ref3.format,
      format = _ref3$format === void 0 ? 'png' : _ref3$format;
  emojiSource = {
    url: url,
    format: format
  };
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee2(fontFamily, doc) {
    var font, src, headers, body, _font$method, method, data;

    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            font = getFont(fontFamily); // We cache the font to avoid fetching it many times
            ...
            src = font.src, headers = font.headers, body = font.body, _font$method = font.method, method = _font$method === void 0 ? 'GET' : _font$method;
            _context2.next = 7;
            return fetchFont(src, {
              headers: headers,
              method: method,
              body: body
            });
...
export default dom;
export { Document$2 as Document, BlobProvider, PDFViewer, PDFDownloadLink, pdf, View$1 as View, Text$1 as Text, Link$1 as Link, Page$1 as Page, Font, Note$1 as Note, Image$1 as Image, Canvas$1 as Canvas, version, StyleSheet, PDFRenderer$1 as PDFRenderer, createInstance };
