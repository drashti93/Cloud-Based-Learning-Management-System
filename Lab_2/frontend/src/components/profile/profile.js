            	...
            	<div>
                        ...
                        <div className="container form_container">
                            ...
                            <div className="row">
                                ...
                                <input className="btn btn-success" id="save_button" type="button" value="Save" disabled={this.state.isDisabled} onClick={() =>{this.props.setProfile(this.props.user_id, this.state.email, this.state.phone_number, this.state.about_me, this.state.city, this.state.company, this.state.school, this.state.country, this.state.hometown, this.state.languages, this.state.gender, this.state.profile_img); this.sweetAlert()}}/>
                            </div>
                            </form>
                            </div>
                         </div>
