...
class Sidebar extends Component {
    ...
    componentDidMount(){
        if(this.props.isStudent === "on"){
            this.setState({
                isHidden: true,
                navTo: "http://warm-sierra-47496.herokuapp.com/enroll",
                    ...
                    <div className="wrapper">
                        ...
                        <div id="content_div">
                            <ul className="list-unstyled components">
                                ...
                                <li id="sidebarbutton">
                                    <a href="http://warm-sierra-47496.herokuapp.com/dashboard/d" className="active">
                                        <div className="containerSideBar">
                                ...
                                <li id="sidebarbutton">
                                    <a href="http://warm-sierra-47496.herokuapp.com/message">
                                        <div className="containerSideBar">
                        ...
                        <div id="mySidebar1" className="sidebar" style={{width: this.state.sidebar_width1}}>
                            ...
                            <div className="sidebar-header">
                                ...
                                <button id="logout" className="btn btn-danger" type="submit" onClick={() => this.props.logout()}>Log Out</button>
                                </div>
                                <div className="text">Account</div>
                            </div>
