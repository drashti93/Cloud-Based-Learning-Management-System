...
class AddAssignment extends Component {
    ...
    gradeChange(event){
        this.setState({assignment_grade: event.target.value})
    }
    ...
    sweetAlert(){
        ...
        swal("Great", "Assignment Added", "success")
        .then(() => {
            this.reload_screen();
        })
}
        ...
        <form>
                ...
                <div className="form-row">
                    ...
                    <div className="form-group col-md-6 form_assignment">
                        ...
                        <input type="number" className="form-control " value={this.state.assignment_grade} id="grade" placeholder="Grade" onChange={this.gradeChange}/>
                    </div>
                </div>
                <div className="form-row">
                <div className="form-group col-md-6 form_assignment">
                ...
                <div className="form-row">
                    <input className="btn btn-success" type="button" value="Save" onClick={() =>{this.props.addNewAssignment(this.state); this.sweetAlert()}} id="save_assignment" />
                </div>
              </form>
            </div>  
