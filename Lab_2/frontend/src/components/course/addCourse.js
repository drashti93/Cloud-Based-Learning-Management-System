                    ...
                    <Sidebar/>
                      <div id="assignment_container" className="container">
                        <div>
                            ...
                            <div className="form-row">
                                <button type="submit" className="btn btn-success" name="save_assignment" onClick={() =>{this.props.addCourse(this.props.user_id,this.state.course_id,this.state.course_name, this.state.course_department,this.state.course_description,this.state.room_number,this.state.student_capacity,this.state.waitlist_capacity,this.state.course_term, this.props.user_name ); this.sweetAlert()}} >Save</button>
                            </div>
