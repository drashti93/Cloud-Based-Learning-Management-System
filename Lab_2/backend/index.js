...
app.use(cors({ origin: 'http://warm-sierra-47496.herokuapp.com', credentials: true }));
...
app.use(function(req, res, next) {
    res.setHeader('Access-Control-Allow-Origin', 'http://warm-sierra-47496.herokuapp.com');
